# Cocoon API Electron Desktop App

This directory contains the Electron wrapper for Cocoon API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Cocoon API/data/`
  - Windows: `%APPDATA%/Cocoon API/data/`
  - Linux: `~/.config/Cocoon API/data/`
